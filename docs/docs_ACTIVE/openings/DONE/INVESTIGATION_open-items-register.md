...
> — 21 of 8,153 buildings do not move a fleet baseline and no attempt was made. It is **not** a
...
is low by an unknown amount that is ~1 % *on the four buildings where it has been measured*. Sizing it
