...
`docs/docs_ACTIVE/openings/implemenation/previous/PLAN_rulings-and-fixes-2026-08-21.md`
...
- Suite baseline: **1,927 passed / 55 skipped / 0 failed.** The authoritative baseline is the
  enumerated 55-skip table in §9 of `docs/docs_ACTIVE/openings/implemenation/previous/PLAN_rulings-and-fixes-2026-08-21.md`,
...
differenced.** ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
...
`docs/docs_ACTIVE/openings/implemenation/previous/PLAN_open62-z-origin-and-three-rulings-2026-08-20.md:840-870`).
...
replacement.** ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations. Include F7's warning that 152.3011 and 153.8231 are different populations and must not
...
- 🛑 **CP-2 — after T03.** The candidate fleet figure exists. **The only question at CP-2 is the
  ...
  correction as a stated caveat. ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.** The executor does not answer it and does not pre-empt it.
...
adopted figure" was written anywhere. ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
...
different populations.** ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
...
are different populations — never difference them.** ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
...
the correction as a stated caveat.** The restatement is **not** adopted. ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
...
corrected 153.8231"* because that quantity does not exist yet. ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
...
premature. ⚠ superseded 2026-09-10: restated at 153.95 kWh/m² over 8,139 buildings (different population from 8,153 — see PLAN_accuracy-restatement-2026-09-09.md T08, CP-4). Do not diff the two numbers without stating both populations.
