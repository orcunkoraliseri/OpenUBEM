...
- Competing reading: `implemenation/PLAN_compute-queue.md:343`,
...
- Files that mention the ID at all (15, from `grep -rl`): the four above plus
  ...
  `extra/MEASUREMENT_open-29_eight-defect-recheck.md`, `implemenation/PLAN_no-compute-queue.md`,
  `implemenation/PLAN_five-more-items-2026-08-13.md`, the register, `docs/PROJECT_CHECKLIST.md`, and
