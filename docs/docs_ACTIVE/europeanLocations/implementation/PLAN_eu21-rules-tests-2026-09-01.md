...
grep -c 'class="fig"' docs/docs_ACTIVE/europeanLocations/rules/tests/TEST_01_three_per_group_2026-09-01.html
```
...
- `docs/docs_ACTIVE/europeanLocations/rules/tests/TEST_01_three_per_group_2026-09-01.html` (new, 94430 bytes).
...
- `docs/docs_ACTIVE/europeanLocations/rules/tests/TEST_02_floor_sizes_x3_2026-09-01.html`,
