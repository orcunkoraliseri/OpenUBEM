...
- The v3 director prompt's carried item (ii), *"measured neighbour counts 30.1–49.1 vs the 11.1–12.2 in
  ...
  **11.88 / 12.28 / 7.52 / 11.22** (Madrid / Lyon / London / Bologna), medians 12 / 12 / 7 / 11, zero
  ...
  `rules/RULES_context_geometry_simulation_nocore_2026-09-02.md` §1 (12.16 / 11.98 / 11.60 / 11.14). **London is the
...
6. **"According to our rules" means `rules/`.** A plan is compliant when it satisfies
   `rules/RULES_dwelling_layout_scheme_nocore_2026-09-02.html` (superseded 2026-09-02 by the no-core
   regime, `D-EU-79`; original archived at `rules/archive/RULES_dwelling_layout_scheme_2026-08-28.html`),
   the acceptance conditions of `rules/EXAMPLE_dwelling_layout_validation_nocore_2026-09-02.md` §6, and
   `rules/RULES_context_geometry_simulation_nocore_2026-09-02.md` R1–R9 — not merely when the code emitted it
...
| Dwelling-layout rule + acceptance test (no-core regime, `D-EU-79`, 2026-09-02) | `rules/EXAMPLE_dwelling_layout_validation_nocore_2026-09-02.md`, `rules/RULES_dwelling_layout_scheme_nocore_2026-09-02.html` |
| Context-geometry rule (still in force, unchanged; renamed 2026-09-02) | `rules/RULES_context_geometry_simulation_nocore_2026-09-02.md` |
